        ...
        NamedBlock(
            ...
            Sequential(
                ...
                Collection(
                    ...
                    Sequential(
                        "**Check all mentioned sources**: If the {user} suggests checking multiple specific tools or platforms (e.g., Notion, Gmail, Slack), you should prioritize exploring **all** of them to gather comprehensive context. Do not stop searching after checking just one partial source.",
                    ),
...
AGENT_TASK_BEGIN = NamedBlock(
    ...
    content=Sequential(
        ...
        "Notice: You should check all the tools mentioned by the {user} in the {user_input} to gather comprehensive context.",
    ),
)
