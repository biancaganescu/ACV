...
def llm_register_args(parser, prefix=None, shortprefix=None, defaults={}):
    ...
    max_tokens = defaults.get("max_tokens", None) # 100000
...
def load_openai_llm(
    ...
    if "gpt-5" in model_name:
        kwargs.pop("max_tokens", None)  # gpt-5 does not support max_tokens
    ...
    if model_name.startswith("claude"):  # claude-1
        ...
        return ChatOpenAI(model_name=model_name, openai_api_base="http://0.0.0.0:8000/v1", **kwargs)
